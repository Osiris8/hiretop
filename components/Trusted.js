      ...
      <div class="px-8 py-24 mx-auto md:px-12 lg:px-32 max-w-7xl">
        <div class="grid grid-cols-2 gap-0.5 md:grid-cols-5">
          <div class="flex justify-center col-span-1 px-8">
            <Image class="max-h-12" src={logo1} alt="logo" />
          </div>
          <div class="flex justify-center col-span-1 px-8">
            <Image class="max-h-12" src={logo2} alt="logo" />
          </div>
          <div class="flex justify-center col-span-1 px-8">
            <Image class="max-h-12" src={logo3} alt="logo" />
          </div>
          <div class="flex justify-center col-span-1 px-8">
            <Image class="max-h-12" src={logo4} alt="logo" />
          </div>
          <div class="flex justify-center col-span-1 px-8">
